...
from distributed import Client, LocalCluster, Worker, stealing, wait
...
class WorkerRestrictionsSuite:
    ...
    def setup(self, resource, steal_interval):
        ...
        cluster = LocalCluster(
            n_workers=1, threads_per_worker=1, resources=rdict, worker_class=Worker
        )
    ...
    def time_trivial_tasks(self, resource, steal_interval):
        ...
        futures = client.map(slowinc, range(10), delay=0.1, resources=rdict)
